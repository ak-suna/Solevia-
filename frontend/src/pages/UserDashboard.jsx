...
//   // Improved Logic for the Side Panel
//   const getSelectedDateDetails = () => {
//     if (!selectedDate) return null;
//     const dateStr = selectedDate.toISOString().split('T')[0];

//     const mood = moodHistory.find(entry => new Date(entry.date).toISOString().split('T')[0] === dateStr);
//     const dayJournals = journals.filter(j => new Date(j.date).toISOString().split('T')[0] === dateStr);
//     const habitDay = habitHistory.find(h => new Date(h.date).toISOString().split('T')[0] === dateStr);
