...
//     // Filter out admin from the members list
...
//             key: 'status',
//             label: 'Status',
//             accessor: row => row.disabled ? 'Disabled' : 'Active',
//             sortable: true,
//         },
//         {
//             key: 'actions',
...
//                 ? <button className="text-green-600" onClick={() => handleDisable(row.userId._id || row.userId, true)}>Enable</button>
//                 : <button className="text-red-600" onClick={() => handleDisable(row.userId._id || row.userId, false)}>Disable</button>,
//         },
//         {
//             key: 'reason',
