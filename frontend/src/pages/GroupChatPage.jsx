...
const GroupChatPage = () => {
    ...
    getMyPeerConnections(groupId)
      .then((data) => {
        ...
        if (target) {
          ...
          setCalendlyInput(target.calendlyLink || "");
  ...
  const handleSelectConnection = useCallback(
    (conn) => {
      ...
      setCalendlyInput(conn.calendlyLink || "");
  ...
  const handleSaveCalendly = async () => {
    if (!activeId) return;
    try {
      await savePeerCalendlyLink(activeId, calendlyInput);
      setLinkSaved(true);
              ...
              <div className="flex-1 flex flex-col min-w-0">
                ...
                <div className="flex items-center gap-3 px-6 py-5 border-b-2 border-gray-100 dark:border-gray-700 flex-shrink-0">
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-full text-xs font-semibold transition-all ${showCalendly
                ...
                {/* Calendly card — styled like dashboard's inner panels */}
                {showCalendly && (
                      ...
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-400 dark:text-gray-500">
                            Share your Calendly link with {otherName}
                          </p>
                        </div>
                      </div>
