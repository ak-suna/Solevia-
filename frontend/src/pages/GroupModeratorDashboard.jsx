...
//                 <h1 className="text-2xl font-bold mb-6">Moderator Dashboard for {group?.name || 'Group'}</h1>
//                 <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
//                     <div className="bg-[#f9d9e3] rounded-xl p-6 shadow flex flex-col items-center">
//                         <div className="text-3xl font-bold">{totalMembers}</div>
//                         <div className="text-lg mt-2">Total Members</div>
//                     </div>
//                     <div className="bg-[#f9d9e3] rounded-xl p-6 shadow flex flex-col items-center">
//                         <div className="text-3xl font-bold">{pendingRequests}</div>
//                         <div className="text-lg mt-2">Pending Join Requests</div>
//                     </div>
//                     <div className="bg-[#f9d9e3] rounded-xl p-6 shadow flex flex-col items-center">
//                         <div className="text-3xl font-bold">{pendingReports}</div>
//                         <div className="text-lg mt-2">Pending Reports</div>
//                     </div>
//                 </div>
//                 {/* Add more dashboard widgets or links here if needed */}
//             </div>
//         </div>
//     );
// };
