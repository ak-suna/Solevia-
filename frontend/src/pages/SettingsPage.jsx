...
//                 {/* Left Sidebar */}
//                 <div className="w-full lg:w-72 bg-white dark:bg-gray-800 rounded-3xl p-6 shadow-lg flex-shrink-0">
...
//                             <form onSubmit={handlePasswordSubmit} className="space-y-4 w-full max-w-lg bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
//                                 <div>
            ...
            <div className="flex-1 flex items-center justify-center mt-12">
                <div className="flex gap-6 w-full max-w-6xl">
                    ...
                    <div className="flex-1 bg-white dark:bg-gray-800 rounded-[50px] p-8 shadow-[0_10px_25px_rgba(248,186,144,0.25)] dark:shadow-[0_10px_25px_rgba(0,0,0,0.3)] border-2 border-gray-200 dark:border-gray-700 max-h-[775px] overflow-y-auto">
                        ...
                        {activeSection === "notifications" && (
                            <div>
                                <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-6" style={{ fontFamily: "Brasika" }}>Notifications</h2>
                                <div className="bg-[#f096b3]/10 dark:bg-[#6ca859]/10 p-8 rounded-2xl text-center border border-[#f096b3]/20 dark:border-[#6ca859]/20">
                                    <p className="text-gray-600 dark:text-gray-400">Notification preferences coming soon...</p>
                                </div>
                            </div>
                        )}
