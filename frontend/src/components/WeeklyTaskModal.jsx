    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Set Weekly Task">
            <div className="mb-4">
                ...
                <textarea
                    className="w-full p-3 rounded-lg border border-gray-300 dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-[#f4873e]"
                    rows={4}
                    value={task}
