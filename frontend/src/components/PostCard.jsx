...
//                 {/* 2. Check if an image exists and render it */}
//                 {post.image && (
//                     <div className="relative mt-3 mb-4 rounded-2xl overflow-hidden bg-gray-100 dark:bg-gray-700 border border-gray-200 dark:border-gray-600">
//                         <img
//                             src={post.image}
//                             alt="Post attachment"
//                             className="w-full h-auto max-h-[450px] object-cover hover:scale-[1.02] transition-transform duration-300"
//                             // This handles any potential broken links gracefully
//                             onError={(e) => {
