...
const CapsuleForm = ({ onSubmit, onCancel, loading }) => {
    ...
    return (
        <>
            ...
            >
                ...
                {/* Content Editor */}
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg p-4 min-h-[12rem] mb-4">
